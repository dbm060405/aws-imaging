...
* The original package name 'com.example.aws.aws-imaging' is invalid and this project uses 'com.example.aws.awsimaging' instead.
# Learning tool
This was a good way to start learning how to integrate with AWS. Thanks for the 
help amigoscode.
# Getting Started
